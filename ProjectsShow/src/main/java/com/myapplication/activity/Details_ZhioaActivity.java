 ...
 */
public class Details_ZhioaActivity extends Activity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.iv_details_back:
                Details_ZhioaActivity.this.finish();
                break;
            case R.id.tv_play:
                Intent intent = new Intent(Details_ZhioaActivity.this,WebViewActivity.class);
