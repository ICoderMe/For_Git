$(function(){
        //联系人高度
        var sortHeight=$(window).height()-$(".header").outerHeight()-$(".sub-menu").outerHeight()-$(".menu").outerHeight();
        $(".sort_box").css("height",sortHeight);
        ...
        $(".initials ul li").click(function(){
            ...
            Initials.css('background','rgba(231,237,237,1)');
        ...
        Initials.height(sortHeight);
        var LiHeight=sortHeight/28;
